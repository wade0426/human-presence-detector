"""今日工作模型（自 tests/test_today_work_model.py 移植，改用 core snapshot）。"""
...
from src.shell.widgets.today_work_model import TodayWorkDisplay, TodayWorkModel
...
def _snap(work_elapsed: float, state: TimerState = TimerState.WORKING) -> TimerSnapshot:
    """Build a minimal core TimerSnapshot with the given work_elapsed_sec."""
