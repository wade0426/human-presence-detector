"""連線狀態徽章（自 src/ui/widgets/connection_badge.py 移植）。"""

from __future__ import annotations

from PySide6.QtWidgets import QHBoxLayout, QLabel, QWidget

from src.shell.strings import CONN_TEXT
from src.shell.widgets.connection_state import ConnectionState, icon_key, severity
...
class ConnectionBadge(QWidget):
    ...
    def set_state(self, state: ConnectionState) -> None:
        ...
        role = severity(state)
        text = CONN_TEXT.get(state.value, "")
